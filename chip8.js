...
function run(opcode) {
	...
	if (opcode >> 12 == 0x1)
		return "Jumps to address  " + (opcode & 0xfff).toString(16);
	...
	if (opcode >> 12 == 0x3)
		return "Skips the next instruction if V" + ((opcode & 0xf00) >> 8).toString(16) + " equals " + (opcode & 0xff).toString(16);
	...
	if (opcode >> 12 == 0xa)
		return "Sets I to the address " + (opcode & 0xfff).toString(16);	
